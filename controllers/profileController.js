...
export const createProfile = async (req, res) => {
    try {
        ...
        const { name, age, location, instagramFollowers, engagementPercentage, averageROI } = req.body;
        const image = req.file ? req.file.filename : null;

        if (!name || !age || !location || !instagramFollowers || !engagementPercentage || !averageROI) {
...
export const updateProfile = async (req, res) => {
    try {
        ...
        profile.instagramFollowers = req.body.instagramFollowers || profile.instagramFollowers;
